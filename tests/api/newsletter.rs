...
async fn newsletter_creation_is_idempotent() {
    ...
    "title": "Newsletter title",
    "text_content": "Newsletter body as plain text",
    "html_content": "<p>Newsletter body as HTML</p>", // We expect the idempotency key as part of the
...
async fn concurrent_form_submission_is_handled_gracefully() {
    ...
    let response1 = app.post_publish_newsletter(&newsletter_request_body); //ก่อน commmit สร้างไหม
